...
public class DownloadManager extends javax.swing.JFrame implements Observer, Runnable {
    ...
    private void actionAdd() {
        ...
        try {
            ...
            System.err.println("URL Mal Formatada : " + ex.getMessage());
        }
        if (verifiedURL != null) {
    ...
    private void initComponents() {
    	...
    	File f = new File("./src/main/resources/META-INF");	
        ...
        addButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/add.png"));
        ...
        buttonAlterarPath.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/folder_link.png"));
        ...
        pauseButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/control_pause_blue.png"));
        ...
        resumeButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/control_play_blue.png"));
        ...
        cancelButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/control_stop_blue.png"));
        ...
        clearButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/cancel.png"));
        ...
        restartButton.setIcon(new javax.swing.ImageIcon(f.getPath() + "/lib/icons/control_repeat_blue.png"));
        ...
        downloadsTable.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
        ...
        jLabel1.setText("by Felipe Rodrigues Michetti - (is Hiring) ? \"Mail Me - feliperm@gmail.com\" : \"Visit : http://portfolio-frmichetti.rhcloud.com/\"");
